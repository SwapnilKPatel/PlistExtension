...
//  DEMO
//
//  Created by Swapnil Patel on 23/04/19.
...
//to get data   let values = Bundle.contentsOfFile(plistName: "Settings.plist")
public extension Bundle {
    ...
    /**
     ...
     - returns: dictionary of values
     */
    static func contentsOfFile(bundleURL: NSURL, plistName: String = "My.plist") -> [String : AnyObject] {
